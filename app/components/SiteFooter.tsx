...
export default function SiteFooter() {
  return (
    <footer className="border-t border-neutral-200/70 bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 py-10 text-sm text-neutral-600 sm:flex-row sm:items-center sm:justify-between">
        <p>Remobilizer — Executive-grade insights for the AI era.</p>
